    ...
    export default {
        ...
        methods:{
            ...
            contentList(){ // 初始化数据
                var num = 0;
                var _this = this;
                this.$http.get('/LuchyBird/manage/orderByPage.do?clubId='+_this.clubId+'&state=2&page=1&pageSize='+this.pageSize+'&startTime='+this.allStartTime+'&endTime='+this.allEndTime+'').then(function(data){
            ...
            dateUpdateData(startTime,endTime){ // 改变日期对应改变数据
                var _this = this;
                this.$http.get('/LuchyBird/manage/orderByPage.do?clubId='+this.clubId+'&state=2&page=1&pageSize='+this.pageSize+'&startTime='+startTime+'&endTime='+endTime+'').then(function(data){
                    var value = data.data.data;
                    var num = 0;
                    if(value == '' || value == null){
                        _this.dataList = [];
            ...
            loadMore() { // 加载更多
                ...
                // setTimeout(()=>{
                    this.page ++;
                    this.$http.get('/LuchyBird/manage/orderByPage.do?clubId='+_this.clubId+'&state=2&page='+this.page+'&pageSize='+this.pageSize+'&startTime='+this.allStartTime+'&endTime='+this.allEndTime+'').then(function(data){
                        var value = data.data.data;
